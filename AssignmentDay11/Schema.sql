...
(1, 1, 101, 'Organic Honey', 'Honey biologique', 1, 12.99, 100, 20, 10, FALSE),
(2, 1, 102, 'Almond Butter', 'Beurre d\'amande', 1, 6.49, 50, 10, 5, FALSE),
(3, 2, 101, 'Quinoa', 'Quinoa', 1, 4.99, 200, 30, 15, FALSE),
(4, 3, 103, 'Coconut Oil', 'Huile de noix de coco', 1, 8.99, 75, 5, 3, TRUE),
(5, 4, 102, 'Chia Seeds', 'Graines de chia', 1, 3.99, 150, 25, 10, FALSE);
...
(1, 'John Doe', '123 Maple St', 'Toronto', 'Ontario', 12345, 'Canada', 'FedEx', '2024-09-01', '2024-09-10', '2024-09-05', 101, 15.75),
(2, 'Jane Smith', '456 Oak St', 'Vancouver', 'British Columbia', 67890, 'Canada', 'DHL', '2024-09-02', '2024-09-12', NULL, 102, 25.50),
(3, 'Alice Johnson', '789 Pine Rd', 'Montreal', 'Quebec', 54321, 'Canada', 'UPS', '2024-09-03', '2024-09-15', '2024-09-10', 103, 10.00),
(4, 'Bob Brown', '321 Birch Blvd', 'Calgary', 'Alberta', 11223, 'Canada', 'USPS', '2024-09-04', '2024-09-14', '2024-09-11', 104, 30.25),
(5, 'Charlie Green', '654 Cedar Ln', 'Ottawa', 'Ontario', 33445, 'Canada', 'Amazon', '2024-09-05', '2024-09-20', NULL, 105, 12.00);
